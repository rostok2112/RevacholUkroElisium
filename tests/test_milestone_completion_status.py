...
class MilestoneCompletionStatusTests(unittest.TestCase):
    ...
    def test_matrix_blocks_m5_until_manual_completion(self) -> None:
        ...
        self.assertTrue(fixture["runtime_targeted_hook_candidate_research_local_report_done"])
        self.assertTrue(fixture["runtime_targeted_hook_candidate_research_review_gate_done"])
    ...
    def test_accepts_m1_complete_and_advances_to_m2_manual_review(self) -> None:
        ...
        mutated["runtime_targeted_hook_candidate_research_local_report_done"] = False
        mutated["runtime_targeted_hook_candidate_research_review_gate_done"] = False
    ...
    def test_runtime_first_requires_transport_done_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_current_line_transport_done"] = False
    ...
    def test_runtime_first_requires_capture_strategy_decision_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_current_line_capture_strategy_decision_done"] = False
    ...
    def test_runtime_first_requires_targeted_hook_report_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_targeted_hook_candidate_research_local_report_done"] = False
    ...
    def test_runtime_first_requires_targeted_hook_review_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_targeted_hook_candidate_research_review_gate_done"] = False
    ...
    def test_runtime_first_requires_targeted_hook_decision_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_targeted_hook_candidate_decision_contract_done"] = False
    ...
    def test_runtime_first_requires_private_hook_descriptor_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_private_hook_descriptor_contract_done"] = False
    ...
    def test_runtime_first_requires_private_hook_descriptor_local_validation_marker(self) -> None:
        fixture = load_json(FIXTURE_PATH)
        mutated = copy.deepcopy(fixture)
        mutated["runtime_private_hook_descriptor_local_validation_done"] = False
