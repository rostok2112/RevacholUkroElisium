...
from scripts.review_m0_manual_verification import (
    FALSE_SAFETY_FIELDS,
    PRIVATE_REPORT_ROOT,
    PRIVATE_REVIEW_ROOT,
...
FIXTURE_PATH = ROOT / "tests/fixtures/m0_manual_verification_report.synthetic.json"


class M0ManualVerificationTests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            for path in (
                ...
                with self.subTest(path=path):
                    with self.assertRaises(M0ManualVerificationError):
